...
| --- | --- | --- | --- |
| Android | [`android`](android) | [krdpass-auth-sdk-android](https://github.com/ditkrg/krdpass-auth-sdk-android) | Maven Central `krd.pass:krdpass-auth:1.4.0` |
| iOS | [`ios`](ios) | [krdpass-auth-sdk-ios](https://github.com/ditkrg/krdpass-auth-sdk-ios) | Swift Package Manager, exact `1.4.0` |
| Flutter | [`flutter`](flutter) | [krdpass-auth-sdk-flutter](https://github.com/ditkrg/krdpass-auth-sdk-flutter) | git dependency `ref: v1.4.0` |
| React Native (Expo) | [`react-native`](react-native) | [krdpass-auth-sdk-react-native](https://github.com/ditkrg/krdpass-auth-sdk-react-native) | git dependency `#v1.4.0` |
| React Native (bare) | [`react-native-bare`](react-native-bare) | same | git dependency `#v1.4.0` |
