...
struct DashboardView: View {
                ...
                VStack(spacing: 16) {
                    ...
                    Button {
                        ...
                        HStack {
                            ...
                            Text(viewModel.isLoadingUserInfo ? "Syncing..." : "Sync with Remote UserInfo")
                        }
                    ...
                    .disabled(viewModel.isLoadingUserInfo)
    ...
    private func claimSection(title: String, claims: [String: JSONValue]) -> some View {
                ...
                if claims.isEmpty {
                    ...
                    ForEach(Array(claims.keys.sorted()), id: \.self) { key in
                        HStack(alignment: .top, spacing: 8) {
                            ...
                            Text(String(describing: claims[key]?.jsonObject ?? ""))
                                .font(.caption2)
                                .foregroundColor(.secondary)
                                .lineLimit(3)
                        }
    ...
    private var tokenManagementSection: some View {
        VStack(spacing: 0) {
            ...
            // The action result line lives in ContentView: "Tokens revoked, signed out" has to
            // outlive this card, which disappears the moment the revoke succeeds.
