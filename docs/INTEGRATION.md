...
| --- | --- |
| [Android](https://github.com/ditkrg/krdpass-auth-sdk-android) | Maven Central `krd.pass:krdpass-auth:1.5.0` |
| [iOS](https://github.com/ditkrg/krdpass-auth-sdk-ios) | SwiftPM or CocoaPods, git tag `v1.5.0` |
| [Flutter](https://github.com/ditkrg/krdpass-auth-sdk-flutter) | pubspec git dependency, `ref: v1.5.0` |
| [React Native](https://github.com/ditkrg/krdpass-auth-sdk-react-native) | npm git dependency, `#v1.5.0` |
